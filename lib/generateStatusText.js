...
const FRASA = {
  ...
  ibadah: {
    ramai: [
      "🕌 Saf penuh", "🤲 Jamaah full", "🕋 Parkir penuh",
  ...
  kesehatan: {
    ramai: [
      "🏥 Kursi tunggu penuh", "👨‍⚕️ Antre panjang", "🩺 Banyak pasien",
      "🏥 Pakai Nomor antrean", "👨‍⚕️ Dokter sibuk", "💊 Resep Obat menumpuk"
    ],
    sepi: [
  ...
  pendidikan: {
    ramai: [
      "📚 Ruang kelas penuh", "👨‍🎓 Kantin ramai", "🏫 Jam pelajaran",
