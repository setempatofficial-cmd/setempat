      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-2xl font-black text-slate-900">
            Mlebu Setempat<span className="text-[#E3655B]">ID</span>
          </h2>
          <p className="text-slate-500 text-sm mt-2 font-medium">
            Pilih cara masuk yang paling gampang, Lur.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {!sent ? (
            ...
            <motion.div 
              ...
              className="bg-green-50 text-green-600 p-4 rounded-2xl text-xs font-bold text-center"
            >
        ...
        <button 
          onClick={onClose} 
          className="w-full mt-8 text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] hover:text-[#E3655B] transition-colors"
        >
          Tutup
        </button>
      </motion.div>
