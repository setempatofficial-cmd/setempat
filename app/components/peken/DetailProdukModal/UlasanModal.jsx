      ...
      <div className="bg-white w-full max-w-[420px] rounded-t-[40px] p-8 pb-10 animate-in slide-in-from-bottom duration-500 shadow-2xl relative">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-3 p-3 bg-stone-50 rounded-2xl">
            {product.foto_url?.[0] ? (
              <img src={product.foto_url[0]} className="w-12 h-12 rounded-xl object-cover" />
            ) : (
            ...
            <div>
              <p className="font-black text-stone-800">{product.nama_barang}</p>
          ...
          <div className="space-y-2 text-left">
            ...
            <textarea 
              ...
              placeholder="Contoh: Barangnya seger pol, kirimnya cepet, penjualnya ramah..."
