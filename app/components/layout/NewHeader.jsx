...
export default function Header({
  ...
  return (
    <header
      className={`sticky top-0 z-[1000] transition-all duration-300 ${isScrolled ? theme.bgGlass : theme.bg
      ...
      <div className="px-4 py-3">
        ...
        <div className="flex items-center gap-2 h-16">
          ...
          <button
            ...
            className={`flex items-center gap-2 flex-shrink-0 transition-all duration-300 rounded-xl active:scale-95 ${isScrolled
                ? theme.isMalam
          ...
          >
            <div
              className={`transition-all duration-300 ease-out flex-shrink-0 bg-[#E3655B] rounded-lg flex items-center justify-center shadow-md ${isScrolled ? "w-8 h-8" : "w-10 h-10"
                }`}
            >
              <svg
            ...
            <div className="flex items-center gap-1">
              <span
                className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${locationReady
          ...
          <div className="relative flex-1 h-10 flex items-center min-w-0">
            ...
            <button
              onClick={onOpenLocationModal}
              className={`absolute inset-0 flex flex-col items-start transition-all duration-300 ease-out origin-left overflow-hidden ${isScrolled ? "opacity-0 -translate-y-4 pointer-events-none" : "opacity-100 translate-y-0"
                }`}
            >
            ...
            <div
              className={`w-full transition-all duration-300 ease-out ${isScrolled ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-8 scale-95 pointer-events-none"
                }`}
            >
        ...
        <div
          className={`transition-all duration-500 ease-in-out overflow-hidden ${isScrolled ? "max-h-0 opacity-0 py-0 mt-0" : "max-h-[100px] opacity-100 pt-3 mt-0"
            }`}
        >
          <div className="relative">
            <input
            ...
            <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-2">
              ...
              >
                ...
                <div className="relative flex h-2 w-2">
                  <span
                    className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 ${theme.isMalam ? "bg-cyan-400" : "bg-[#E3655B]"
                      }`}
                  ></span>
