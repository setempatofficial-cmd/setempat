...
export default function Header({
  ...
  return (
    <header className={`sticky top-0 z-[1000] transition-all duration-300 ${
          ...
          <div className={`w-full transition-all duration-300 ease-out ${
            ...
            <div className="relative group">
              <input
                ...
                placeholder={locationReady && villageLocation ? `Cari suasana di ${villageLocation}...` : "Cari suasana aktifkan loksi.."}
      ...
      <div className={`transition-all duration-500 ${isScrolled ? "max-h-0 opacity-0 overflow-hidden" : "max-h-[100px] opacity-100 pb-5"}`}>
        <div className="px-5">
          <div className="relative group">
