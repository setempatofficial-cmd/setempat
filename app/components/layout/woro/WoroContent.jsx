...
<div className={`sticky top-0 z-30 backdrop-blur-xl border-b transition-all ${
  ...
  <div className="mx-auto w-[92%] max-w-[400px]">
    <div className="flex flex-col gap-4 py-4">
      ...
      {/* Baris Bawah: Unified Search Bar */}
      <div 
    ...
    {/* --- HORIZONTAL TABS --- */}
    <div className="flex gap-2 pb-4 overflow-x-auto scrollbar-none snap-x">
      {tabs.map((tab) => {
        ...
        return (
          ...
          >
            ...
            {tab.badge > 0 && !isActive && (
              <span className="absolute -top-1 -right-1 flex h-5 min-w-[20px] items-center justify-center rounded-full bg-red-500 px-1 text-[8px] font-black text-white ring-4 ring-[#111111]">
                {tab.badge}
              </span>
            )}
          </button>
