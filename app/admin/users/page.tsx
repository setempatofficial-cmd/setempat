...
import { 
  ...
  CheckCircle2, XCircle, Loader2, Bike, 
  UserCheck, Briefcase, ShoppingBag
} from 'lucide-react';
                ...
                <tr key={user.id} className="hover:bg-slate-50/50 transition-all">
                  ...
                  <td className="p-6">
                    <div className="flex items-center justify-center gap-2">
                       <button className="p-2.5 text-slate-400 hover:text-purple-600 hover:bg-purple-50 rounded-xl transition-all"><Edit3 size={18} /></button>
